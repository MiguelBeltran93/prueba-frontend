...
export const CardSearchItemListComponent = () => {
    ...
    const productsListData = useSelector(state => state.productReducer.productsList);
    ...
    return (
        <div className={classes.rootContainer}>
            {productsListData && productsListData.items && <CardSearchItemListSection products={productsListData}/>}
        </div>
    )
};